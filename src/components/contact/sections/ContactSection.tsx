    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/assets/rectangle-form.png')",
                }}
            />

                <div
                    className="absolute inset-0 bg-gradient-to-r from-[rgba(0,0,0,0.99)] via-[rgba(3,3,3,0.12)] to-[rgba(7,7,7,1)] opacity-2 blur-[70px]"></div>


                <div className="flex flex-col justify-center items-center h-full space-y-24 px-8 md:px-48 py-24">

                    <div
                        className="flex flex-col justify-center items-center w-full space-y-16 xl:items-start xl:flex-row xl:space-y-0 xl:space-x-48 ">
